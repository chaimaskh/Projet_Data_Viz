...
def create_bar_plot(data):
    ...
    def update_plot(filter_value):
        ...
        filtered_data_top10 = data[data[filter_value].isin(sorted(top_values))]
        ...
        bar_plot = filtered_data_top10.hvplot.bar(
            ...
            xlabel=" ",
            ylabel="Popularity",
            title=f'Top 10 most popular {filter_value}',
            rot=45,
            height=600,
            width=800
        )
    ...
    layout = pn.Column(
                pn.pane.Markdown("# Top 10 Most Popular Bar Plot", style={'text-align': 'center', 'font-size': '24px'}),
